    ...
    <table style="width:100%; border-collapse:collapse;" cellspacing="0" cellpadding="0">
        <tr>
            <td style="width:52%; vertical-align:top; text-align:left; padding-right:14px;">
                <div id="client">
                    <div><b><?php _htmlsc(format_client($invoice)); ?></b></div>
<?php
...
if ($invoice->client_email) {
    echo '<div>' . htmlsc($invoice->client_email) . '</div>';
}
...
?>
                ...
                <div style="margin-top: 16px;">
                    <h1 class="invoice-title <?php echo $text_class ?>" style="margin:0;">
                        <?php _trans('invoice') ?> <?php _htmlsc($invoice->invoice_number) ?>
                    </h1>
                </div>
            </td>
...
?>
                ...
                <div class="invoice-details clearfix" style="margin-top: 12px;">
                    <table style="width:100%; border-collapse:collapse; margin-left:auto;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="text-align:left; padding:2px 0;"><?php _trans('invoice_date'); ?>:</td>
                            <td style="text-align:right; padding:2px 0;"><?php echo date_from_mysql($invoice->invoice_date_created, true); ?></td>
                        </tr>
                        <tr>
                            <td<?php echo $text_class_date ?> style="text-align:left; padding:2px 0;"><?php _trans('due_date'); ?>:</td>
                            <td<?php echo $text_class_date ?> style="text-align:right; padding:2px 0;">
                                <?php echo $invoice->invoice_date_due ? date_from_mysql($invoice->invoice_date_due, true) : ''; ?>
                            </td>
                        </tr>
                        <tr>
                            <td<?php echo $text_class_balance ?> style="text-align:left; padding:2px 0;"><?php _trans('amount_due'); ?>:</td>
                            <td<?php echo $text_class_balance ?> style="text-align:right; padding:2px 0;"><?php echo format_currency($invoice->invoice_balance); ?></td>
                        </tr>
<?php
if ($payment_method) {
?>
                        <tr>
                            <td style="text-align:left; padding:2px 0;"><?php _trans('payment_method'); ?>:</td>
                            <td style="text-align:right; padding:2px 0;"><?php _htmlsc($payment_method->payment_method_name); ?></td>
                        </tr>
<?php
}
?>
...
?>
        ...
        <tr>
            ...
            <td class="text-right">
                <?php echo format_currency(htmlsc($invoice->invoice_item_subtotal)); ?>
            </td>
        </tr>
...
if ($show_qrcode) {
?>
    <table class="invoice-qr-code-table" style="margin-top:20px;">
        <tr>
            <td>
                <div>
